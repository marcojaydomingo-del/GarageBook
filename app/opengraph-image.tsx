...
export const alt="GarageBook — Everything about your car. One garage.";
...
export default async function OpenGraphImage(){
  ...
  return new ImageResponse(
    <div style={{position:"relative",display:"flex",width:"100%",height:"100%",overflow:"hidden",background:"#111516",fontFamily:"GarageBook Manrope"}}>
      ...
      <div style={{position:"relative",display:"flex",width:"640px",height:"100%",flexDirection:"column",justifyContent:"center",padding:"58px 0 58px 70px"}}>
        <div style={{display:"flex",width:"auto",alignSelf:"flex-start",overflow:"hidden",transform:"skewX(-12deg)",fontSize:27,fontStyle:"italic",letterSpacing:"-1.2px",lineHeight:1}}>
          <div style={{display:"flex",background:"#fffdf9",color:"#191c1d",padding:"14px 10px 14px 18px"}}><span style={{transform:"skewX(12deg)"}}>Garage</span></div>
          <div style={{display:"flex",background:"#191c1d",color:"#f3bd3d",padding:"14px 18px 14px 10px"}}><span style={{transform:"skewX(12deg)"}}>Book</span></div>
        </div>
      ...
      <div style={{position:"absolute",right:34,bottom:28,display:"flex",alignItems:"center",gap:10,borderRadius:8,background:"rgba(25,28,29,.88)",padding:"10px 14px",color:"#fffdf9",fontFamily:"Arial",fontSize:16}}>
        garagebook-beta.netlify.app
      </div>
    </div>,
    { ...size,fonts:[{name:"GarageBook Manrope",data:font,weight:800,style:"normal"}] },
  );
}
