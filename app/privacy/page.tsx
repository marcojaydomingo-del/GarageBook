...
export default function PrivacyPage() {
  return <PublicDocument title="Privacy Policy" intro="This beta policy explains what GarageBook stores, why it is needed, and the choices available to you.">
    <section><h2>Information you provide</h2><p>GarageBook stores account information such as your email address, along with the vehicle details, mileage, symptoms, maintenance records, repair cases, shop notes, reminders, photos, receipts, invoices, and other documents you choose to add.</p></section>
    <section><h2>How information is used</h2><p>Your information is used to authenticate your account, operate your private garage, connect related repair records, display your vehicle history, and improve the beta experience. GarageBook does not sell your personal information.</p></section>
    ...
    <section><h2>Security and beta limitations</h2><p>GarageBook uses access controls and private storage paths designed for authenticated owners. No online service can guarantee absolute security. Keep your password private and report suspected unauthorized access promptly.</p></section>
    <section><h2>Children</h2><p>GarageBook is not directed to children under 13 and should not be used to create accounts for them.</p></section>
