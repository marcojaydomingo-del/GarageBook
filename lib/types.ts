...
export interface TimelineEvent { id:string; type:TimelineEventType; title:string; date:string; mileage?:number; description:string; cost?:number; status?:"completed"|"open"|"monitoring"; shop?:string; }
